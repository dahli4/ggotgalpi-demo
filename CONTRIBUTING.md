...
작업 저장소는 https://github.com/dahli4/ggotgalpi-demo 입니다. 클론한 뒤 `GgotgalpiDemo.xcodeproj`를 Xcode에서 엽니다. 외부 패키지는 없습니다.

실기기 실행과 TestFlight는 [docs/COLLABORATION.md](docs/COLLABORATION.md)를 따릅니다. Signing Team과 Bundle Identifier는 커밋된 값을 유지합니다.
